...
class PublishAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(fn (): string => __('Publish :model', ['model' => $this->getTitleCaseModelLabel()]));
        ...
        $this->action(function (): void {
            ...
            Notification::make()
                ->title(__('Ok! :model :title (ID: :id) has been published.', ['model' => $this->getTitleCaseModelLabel(), 'title' => $record->title, 'id' => $record->id]))
                ->success()
                ->send()
