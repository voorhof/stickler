...
class DearchiveAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(fn (): string => __('Dearchive :model', ['model' => $this->getTitleCaseModelLabel()]));
        ...
        $this->action(function (): void {
            ...
            Notification::make()
                ->title(__('Ok! :model :title (ID: :id) has been dearchived.', ['model' => $this->getTitleCaseModelLabel(), 'title' => $record->title, 'id' => $record->id]))
                ->success()
                ->send()
