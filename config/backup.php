...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             *
             * If backing up only the database, you may choose gzip compression for db dump and no compression at zip.
             *
             ...
             * while 9 is the slowest and strongest one.
             *
            ...
            'disk_root_path' => env('BACKUP_DISK_ROOT_PATH', storage_path('app/private/backups')),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('PP_ADMIN_EMAIL', 'hello@example.com'),
    ...
    'cleanup' => [
         ...
         * will keep all backups for a certain number of days. After that period only
         * a daily backup will be kept. After that period only weekly backups will
         * be kept and so on.
         *
         * No matter how you configure it, the default strategy never will
